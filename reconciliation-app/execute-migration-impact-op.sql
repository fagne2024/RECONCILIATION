-- Script pour créer la table impact_op manuellement
-- À exécuter dans votre base de données MySQL

-- Créer la table impact_op
...
SELECT 'Table impact_op créée avec succès!' as message;
SHOW TABLES LIKE 'impact_op';
DESCRIBE impact_op; 