# Script pour migrer tous les alert() vers les pop-ups modernes

Write-Host "Migration de tous les alert() vers les pop-ups modernes..." -ForegroundColor Green
...
foreach ($file in $componentFiles) {
    ...
    if ($content -match "alert\(") {
        ...
        if ($content -notmatch "import.*PopupService") {
            $content = $content -replace "import \{ Injectable \} from '@angular/core';", "import { Injectable } from '@angular/core';`nimport { PopupService } from '../../services/popup.service';"
            $content = $content -replace "import \{ Component", "import { Component"
            if ($content -notmatch "import.*PopupService") {
