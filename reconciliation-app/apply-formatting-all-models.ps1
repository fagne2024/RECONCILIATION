# Script PowerShell pour appliquer les nouvelles options de formatage à tous les modèles
# Auteur: Système de traitement de données
# Date: 2025-01-08

Write-Host "🚀 Script d'application des nouvelles options de formatage à tous les modèles" -ForegroundColor Green
...
$scriptPath = "apply-formatting-to-all-models.js"
...
Write-Host "🔄 Exécution du script de mise à jour pour tous les modèles..." -ForegroundColor Yellow
try {
    node $scriptPath
...
Write-Host "`n📋 Nouvelles fonctionnalités appliquées à tous les modèles:" -ForegroundColor Cyan
...
Write-Host "• guides/INTEGRATION_FORMATAGE_MODELES.md" -ForegroundColor White

Write-Host "`n🎯 Tous les modèles ont été mis à jour avec ces nouvelles options" -ForegroundColor Green
Write-Host "💡 Les nouvelles options sont maintenant disponibles dans l'interface de formatage" -ForegroundColor Yellow 