# Script de test specifique pour le modele CIOMCM avec les cles exactes

$API_BASE_URL = "http://localhost:8080/api"

Write-Host "=== TEST MODELE CIOMCM AVEC CLES EXACTES ===" -ForegroundColor Cyan
Write-Host ""
...
# Donnees de test adaptees aux cles CIOMCM
# Partner Keys: R_f_rence
# BO Keys: IDTransaction
...
Write-Host "Configuration de test CIOMCM:" -ForegroundColor Yellow
...
Write-Host "  Partner (R_f_rence): $($partnerData[0].R_f_rence), $($partnerData[1].R_f_rence), $($partnerData[2].R_f_rence)" -ForegroundColor White
Write-Host ""
